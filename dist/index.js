...
var ReactTaggableField = ({
  ...
  const isMatching = (0, import_react.useRef)(false);
  const highlightEl = (0, import_react.useRef)(null);
  const triggerSymbol = (0, import_react.useRef)();
  const addedTags = (0, import_react.useRef)([]);
  const [showSuggestions, setShowSuggestions] = (0, import_react.useState)(false);
  const [matchingTags, setMatchingTags] = (0, import_react.useState)([]);
  ...
  const matches = (0, import_react.useRef)([]);
  ...
  const updateTags = (0, import_react.useCallback)(() => {
  ...
  })), showSuggestions && /* @__PURE__ */ import_react.default.createElement("div", {
    className: `react-taggable-field-suggested-tags ${suggestionClass}`
  }, matchingTags.map((tag) => /* @__PURE__ */ import_react.default.createElement("div", {
